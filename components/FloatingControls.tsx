      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 animate-fade-in-up">
        ...
        <div className="flex md:hidden flex-col items-end gap-3 mb-1">
          ...
          >
            ...
            <span className="font-display font-bold text-xs tracking-widest uppercase">Dining & Tips</span>
          </a>
          <button
            onClick={onOpenGuide}
          ...
          >
            ...
            <span className="font-display font-bold text-xs tracking-widest uppercase">Digital AI Guide</span>
          </button>
        </div>
        ...
        >
          ...
          <span className="font-display font-bold text-xs md:text-sm tracking-widest uppercase">Rate Experience</span>
        </a>
        ...
        >
          ...
          <span className="font-display font-bold text-xs md:text-sm tracking-widest uppercase">Visiting Madrid?</span>
        </a>
      </div>
    </>
  );
